            ...
            <form action="{{ route('admin.blog_categories.update', $blogCategory->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="name_ar" class="form-control" value="{{ $blogCategory->name_ar }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label required-field">الاسم بالإنجليزية</label>
                        <input type="text" name="name_en" class="form-control" value="{{ $blogCategory->name_en }}" required>
                    </div>
                </div>
