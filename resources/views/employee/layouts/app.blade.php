        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    @if(isset($visiblePages['orders']))
                        <li class="nav-item">
                            ...
                            <ul class="collapse list-unstyled ms-3 {{ request()->routeIs('admin.orders.*') ? 'show' : '' }}" id="ordersSubmenu">
                                ...
                                @if(in_array('view', $visiblePages['orders']))
                                <li class="nav-item">
                                ...
                                @if(in_array('create', $visiblePages['orders']))
                                <li class="nav-item">
                                ...
                                @if(in_array('edit', $visiblePages['orders']))
                                <li class="nav-item">
                                ...
                                @if(in_array('assign', $visiblePages['orders']))
                                <li class="nav-item">
                    ...
                    @if(isset($visiblePages['financial']))
                        <li class="nav-item">
                    ...
                    <!-- Marketing & Campaigns -->
                    @if(isset($visiblePages['marketing']))
                        <li class="nav-item">
                    ...
                    <!-- Employee Management -->
                    @if(isset($visiblePages['employees']))
                        <li class="nav-item">
                    ...
                    <!-- Security & System -->
                    @if(isset($visiblePages['security']))
                        <li class="nav-item">
                            ...
                            <ul class="collapse list-unstyled ms-3 {{ request()->routeIs('admin.security*') ? 'show' : '' }}" id="securitySubmenu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->routeIs('admin.security.settings*') ? 'active' : '' }}"
                                    href="{{ route('admin.security.settings') }}">إعدادات الأمان</a>
                                </li>
                            </ul>
                        </li>
                    @endif
