           ...
           <!-- Actions -->
            <div class="header-actions">
                ...
                <div class="dropdown">
                    ...
                    <li><a class="dropdown-item" href="{{ app()->getLocale() == 'ar' ? route('profile.edit') : route('profile.edit.en') }}">حسابي</a></li>
                    <li><a class="dropdown-item" href="#">طلباتي</a></li>
                    @if(auth()->user()->isAdmin())
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="{{ app()->getLocale() == 'ar' ? route('admin.dashboard') : route('admin.dashboard.en') }}">لوحة التحكم</a></li>
                    @endif
                    <li><hr class="dropdown-divider"></li>
                    <li>
