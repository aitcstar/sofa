                        ...
                        <div class="filter-options">
                            @foreach ($packageNames as $package)
                                <div class="filter-option">
                                    <div class="filter-checkbox" data-filter="package-name"
                    ...
                    <div class="filter-group">
                        ...
                        <div class="filter-options">
                            ...
                            @foreach ($colors as $color)
                                <div class="filter-option">
                                    <div class="filter-checkbox" data-filter="color-style"
                                        data-value="{{ app()->getLocale() === 'ar' ? $color['name_ar'] : $color['name_en'] }}">
                                    </div>
                                    <div class="filter-option-content">
                                        <span
                                            class="body-2 text-body">{{ app()->getLocale() === 'ar' ? $color['name_ar'] : $color['name_en'] }}</span>
                                        <div class="color-swatch"
                                            style="background-color: {{ $color['color_code'] ?? '#000' }}"></div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                            ...
                            <div class="col-sm-12 col-md-6 mb-sm-4 package-cards"
                                ...
                                <div class="room-item">
                                    ...
                                    <div class="image">
                                        @if ($package->{'title_' . app()->getLocale()})
                                            <div class="widget text-center">
                                                <span class="body-4 text-white">
                                                    {{ $package->{'title_' . app()->getLocale()} }} </span>
                                            </div>
                                        @endif
                                        @if ($package->image)
                                            <img src="{{ asset('storage/' . $package->image) }}" class="w-100 h-100"
                                                alt="{{ $package->{'name_' . app()->getLocale()} }}" />
                                        @else
                                            <img src="{{ asset('assets/images/category/category-01.jpg') }}"
                                                class="w-100 h-100" alt="{{ $package->{'name_' . app()->getLocale()} }}" />
                                        @endif
                                    </div>
                                    ...
                                    <div class="content d-flex flex-column gap-sm-3">
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex flex-column gap-sm-6">
                                                <h5 class="sub-heading-3"> {{ $package->{'name_' . app()->getLocale()} }}
                                                </h5>
                                        ...
                                        <div class="d-flex align-items-center gap-sm-5 mb-2">
                                            ...
                                            <h4 class="heading-h6 mb-0">
                                                ...
                                                <img src="{{ asset('assets/images/hero/Platform Subtitle.png') }}"
                                                    alt="" />
                                            </h4>
                                        </div>
                                        ...
                                        <div class="d-flex flex-column gap-sm-2">
                                            ...
                                            <!-- Colors -->
                                            <div class="d-flex gap-sm-3 align-items-center">
                                                <p class="body-2 text-caption mb-0" style="width: 90px;">
                                                    {{ __('site.Available_colors') }}</p>
                                                <div class="d-flex gap-sm-5">
                                                    ...
                                                    @empty
                                                        <span>
                                                            {{ app()->getLocale() == 'ar' ? 'لا توجد ألوان' : 'No Color' }}
                                                        </span>
                                                    @endforelse
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-sm-3 align-items-center">
                                                ...
                                                <div
                                                    class="feature-item d-flex gap-sm-6 border rounded-pill border-surface px-2 py-1">
                                                    <img src="{{ asset('assets/images/icons/clock-watch.png') }}"
                                                        alt="" />
                                                    <span
                                                        class="body-4">{{ $package->{'period_' . app()->getLocale()} }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-sm-3 align-items-center">
                                                ...
                                                <div
                                                    class="feature-item d-flex gap-sm-6 border rounded-pill border-surface px-2 py-1">
                                                    <img src="{{ asset('assets/images/icons/tools-wench-ruler.png') }}"
                                                        alt="" />
                                                    <span
                                                        class="body-4">{{ $package->{'service_includes_' . app()->getLocale()} }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-sm-3 align-items-center">
                                                <p class="body-2 text-caption mb-0" style="width: 90px;">
                                                    {{ __('site.Payment_plan') }}</p>
                                                <div
                                                    class="feature-item d-flex gap-sm-6 border rounded-pill border-surface px-2 py-1">
                                                    <img src="{{ asset('assets/images/icons/wallet-2.png') }}"
                                                        alt="" />
                                                    <span
                                                        class="body-4">{{ $package->{'payment_plan_' . app()->getLocale()} }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-sm-3 align-items-center">
                                                <p class="body-2 text-caption mb-0" style="width: 90px;">
                                                    {{ __('site.Decoration') }}</p>
                                                <div
                                                    class="feature-item d-flex gap-sm-6 border rounded-pill border-surface px-2 py-1">
                                                    <img src="{{ asset('assets/images/icons/brush-ruler.png') }}"
                                                        alt="" />
                                                    <span
                                                        class="body-4">{{ $package->{'decoration_' . app()->getLocale()} }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="actions d-flex gap-sm-2">
                                        ...
                                        <!--<a href="https://wa.me/{{ $siteSettings->whatsapp }}" target="_blank" class="btn btn-custom-primary " >
                                    ...
                                    <a href="{{ app()->getLocale() == 'ar'
                                        ...
                                        <a href="{{ app()->getLocale() == 'ar'
                                            ...
                                            <span style="white-space: nowrap;">{{ __('site.view_details') }}</span>
                                            <i
                                                class="fa-solid fa-arrow-{{ app()->getLocale() === 'ar' ? 'left' : 'right' }} action-icon"></i>
                                        </a>
                    ...
                    @foreach ($mobileColors as $color)
                        @if (is_array($color) && isset($color['name_ar']))
                            <div class="mobile-filter-option">
                                <div class="mobile-filter-checkbox" data-filter="color-style"
                                    data-value="{{ app()->getLocale() === 'ar' ? $color['name_ar'] : $color['name_en'] }}">
                                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function applyFilters(activeFilters) {
                cards.forEach(card => {
                    ...
                    // فلترة اسم الباكج
                    if (activeFilters["package-name"].length && !activeFilters["package-name"].includes(
                            pkgName)) {
                        show = false;
                    }
                    ...
                    if (activeFilters["color-style"].length && !activeFilters["color-style"].some(c =>
                    ...
                    if (activeFilters["unit-type"].length && !activeFilters["unit-type"].some(u => cardUnits
                            .includes(u))) {
                        show = false;
                    }
            ...
            function setupCheckboxes(nodeList) {
                nodeList.forEach(cb => {
                    cb.addEventListener('click', function() {
                        ...
                        applyFilters(getActiveFiltersFrom(nodeList === desktopCheckboxes ?
                            desktopCheckboxes : mobileCheckboxes));
                    });
                });
            }
