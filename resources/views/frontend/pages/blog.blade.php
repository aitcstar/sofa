    ...
    <div class="container d-flex flex-column gap-md">
        ...
        <div class="blog-filter">
            <div class="blog-filter-item {{ request('category') ? '' : 'active' }}">
                <a href="{{ app()->getLocale() == 'ar' ? route('blog.index') : route('blog.index.en') }}" class="sub-heading-5 text-body mb-0">{{ __('site.all') }}</a>
            </div>
            <div class="blog-filter-item {{ request('category') == __('site.tips') ? 'active' : '' }}">
                <a href="{{ app()->getLocale() == 'ar' ? route('blog.index', ['category' => __('site.tips')]) : route('blog.index.en', ['category' => __('site.tips')]) }}" class="sub-heading-5 text-body mb-0">{{ __('site.tips') }}</a>
            </div>
            <div class="blog-filter-item {{ request('category') == __('site.offers') ? 'active' : '' }}">
                <a href="{{ app()->getLocale() == 'ar' ? route('blog.index', ['category' => __('site.offers')]) : route('blog.index.en', ['category' => __('site.offers')]) }}" class="sub-heading-5 text-body mb-0">{{ __('site.offers') }}</a>
            </div>
            <div class="blog-filter-item {{ request('category') == __('site.designs') ? 'active' : '' }}">
                <a href="{{ app()->getLocale() == 'ar' ? route('blog.index', ['category' => __('site.designs')]) : route('blog.index.en', ['category' => __('site.designs')]) }}" class="sub-heading-5 text-body mb-0">{{ __('site.designs') }}</a>
            </div>
            <div class="blog-filter-item {{ request('category') == __('site.reviews') ? 'active' : '' }}">
                <a href="{{ app()->getLocale() == 'ar' ? route('blog.index', ['category' => __('site.reviews')]) : route('blog.index.en', ['category' => __('site.reviews')]) }}" class="sub-heading-5 text-body mb-0">{{ __('site.reviews') }}</a>
            </div>
        </div>
        ...
        <div class="blog-grid">
            ...
            <div class="blog-item d-flex flex-column gap-sm-2">
                ...
                <div class="blog-content d-flex flex-column gap-sm-5">
                    ...
                    <div class="blog-content-item">
                        <a href="{{ app()->getLocale() == 'ar' ? route('blog.details', [$post->slug]) : route('blog.details.en', [$post->slug]) }}" class="d-flex align-items-center gap-sm-5 cursor-pointer" style="height: 40px;">
