            ...
            <div class="d-flex gap-2">
                ...
                <div class="dropdown">
                    <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button"
                            id="bulkActionsDropdown" data-toggle="dropdown">
                        <i class="fas fa-cogs"></i> إجراءات جماعية
                    </button>
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="#" onclick="bulkAssign()">
                            <i class="fas fa-user-tag"></i> تعيين موظف
                        </a>
                        <a class="dropdown-item" href="#" onclick="bulkChangeStatus()">
